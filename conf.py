...
BLOG_EMAIL = "barcelona-python@googlegroups.com"
BLOG_DESCRIPTION = "This is a site for Python Barcelona Group."
...
# If you are writing a multilingual site, you can also create a per-language post file
...
<script>
  ...
  ga('create', 'UA-325034-20', 'pybcn.org');
  ga('send', 'pageview');
